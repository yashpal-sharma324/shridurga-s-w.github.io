  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link" href="misc/index.php">Home <span class="sr-only">(current)</span></a>
      </li>
     
      <li class="nav-item">
        <a class="nav-link" href="misc/services.php">Services</a>
      </li>
	   <li class="nav-item">
        <a class="nav-link" href="misc/about.php">About</a>
      </li>
	   <li class="nav-item">
        <a class="nav-link" href="misc/contact.php">Contact Us</a>
      </li>
...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-12">
		...
		<a href="misc/about.php"class ="btn btn-success"> Check More</a>
		</br>
...
<div class="w-50 m-auto">
	<form action="misc/userinfo.php" method="post">
